...
| pickup_location | location | The pickup location for the order group.                  | Yes
|===
...
| status      | string  | Current status of the order group. See <<Order Group Status (`OrderGroupStatus`)>>
